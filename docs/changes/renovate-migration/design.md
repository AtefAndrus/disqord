...
```json5
{
  ...
  packageRules: [
    ...
    // bun-types は含めない。ランタイムを選ぶ 2 経路とは別の型定義パッケージで、
    // drift-check の対象でもなく、独自のレンジで動くため束ねる必然性がない
    {
