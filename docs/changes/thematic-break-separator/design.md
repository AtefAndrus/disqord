...
| 1 ページの上限 | 1 ページで Separator にするのは 8 本までとし、それを超えた区切り線は `---` の文字に戻す。空になって捨てた区切りは数えない | 区切り線 1 本で Separator と TextDisplay の 2 部品を使い、Discord の 1 メッセージ 40 部品の上限に近づく |
