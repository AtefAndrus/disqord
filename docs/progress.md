...
| [ギルド設定変更の共通認可](changes/permissions/design.md) | 高 | planned | ギルド設定を変更できるかの判定を共通関数 canManageGuildSettings（ManageGuild または admin_role_id のロール）にまとめ、既存のすべての書き込みの入口に掛ける |
